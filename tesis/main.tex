...
\begin{itemize}
    \item Comparar el desempeño de redes neuronales profundas con métodos tradicionales en la imputación de datos faltantes.
    \item Evaluar la precisión de imputación generada por redes neuronales profundas utilizando métricas cuantitativas.
    \item Medir el impacto de los métodos de imputación en la calidad de modelos predictivos, entrenados con los datos imputados.
    \item Identificar los escenarios o tipos de datos en los que las redes neuronales profundas ofrecen ventajas significativas sobre otras técnicas.
\end{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figuras/fig_44_frente_pareto.eps}
