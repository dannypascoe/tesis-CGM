...
% main_pipeline_integrado_v2.m y guarda metricas en la misma carpeta.
% -----------------------------------------------------------------------
...
export_to_excel  = false;     % Exportar tabla a Excel (pipeline_comparison.xlsx en bloque_C/)
...
if compare_vs_unified
    ...
    %
    %  Esto garantiza que AMBAS metricas (desacoplado y unificado) se calculan
    %  sobre el mismo conjunto de muestras y con el mismo método, haciendo la
    %  comparación válida y consistente.
    %
    %  NO se usan los archivos results_<arch>_latest.mat para el esquema unificado,
    %  ya que esos archivos calculan error_impute_all sobre un conjunto de
    %  muestras distinto (señal completa vs. solo segmentos de fallo),
    %  lo que produciría una comparación incorrecta (manzanas vs. naranjas).
    % =========================================================================
...
if export_to_excel
    ...
    fprintf('      Hojas: Lista_16_combinaciones | Tabla4x4_F1 | Tabla4x4_MAE | Co_optimalidad\n');
end
